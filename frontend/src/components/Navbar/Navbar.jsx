...
<header class='flex border-b py-4 px-4 sm:px-10 bg-white font-sans min-h-[70px] tracking-wide relative z-50'>
      <div class='flex flex-wrap items-center gap-4 w-full'>
        <Link to="/">
          <h3 class="text-2xl font-semibold">ClubZ0ne</h3>
        </Link>
          ...
          <div
            ...
            <ul class='lg:flex lg:gap-x-8 max-lg:space-y-2'>
              ...
              <li class='max-lg:border-b max-lg:py-3'>
                <Link to='/'
                  class='hover:text-[#007bff] text-[#007bff] block font-bold text-[15px]'>Home</Link>
              </li>
              ...
              <li class='max-lg:border-b max-lg:py-3'><a href='javascript:void(0)'
                class='hover:text-[#007bff] text-gray-600 block font-bold text-[15px]'>Clubs</a>
              </li>
              <li class='max-lg:border-b max-lg:py-3'><a href='javascript:void(0)'
                class='hover:text-[#007bff] text-gray-600 block font-bold text-[15px]'>Posts</a>
              </li>
            </ul>
        ...
        <div class='flex items-center ml-auto space-x-6'>
          <Link to='/login' class='hover:text-[#007bff] text-gray-600 border-2 p-2 pr-4 rounded-lg border-black block font-bold text-[15px]'>Log
            in</Link>
            <Link to='/login' class='hover:text-[#007bff] text-gray-600 border-2 p-2 rounded-lg border-black block font-bold text-[15px]'>Sign Up
            </Link>
          {/* <button
